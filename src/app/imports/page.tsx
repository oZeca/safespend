...
export default async function ImportsPage({ searchParams }: { searchParams: Promise<{ status?: string }> }) {
  ...
  return <section className="mx-auto max-w-5xl space-y-7"><div><p className="text-sm font-medium text-primary">Imports</p><h1 className="text-3xl font-semibold tracking-tight">Import bank transactions</h1><p className="mt-2 text-sm text-muted-foreground">Upload a CSV or Excel file, map its columns, validate, and confirm transactions before they enter your records.</p></div>
