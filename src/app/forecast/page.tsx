...
const statuses: Record<string, string> = {
  ...
  "forecast-setting-saved": "Projected variable spending preference saved.",
  "forecast-setting-error": "The forecast preference could not be saved."
};
