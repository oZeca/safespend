...
export function AppShell({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <PwaProvider><div className="min-h-screen w-full max-w-full overflow-x-clip bg-muted/40">
      <header className="border-b bg-background">
        <div className="container flex min-h-16 min-w-0 items-center justify-between">
