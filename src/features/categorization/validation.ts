...
import { matchFields, matchTypes } from "./model";
...
export const ruleInputSchema = z.object({
  ...
  pattern: z.string().trim().min(1, "Pattern is required").max(200, "Pattern must be 200 characters or fewer"), categoryId: z.string().trim().min(1, "Select a category"),
